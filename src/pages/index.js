...
import { ScrollPage } from "../components/scrollbutton"

// css
import "../styles/index.css"
import "../styles/main.scss"

// Hide scroll button at the bottom
function onScroll() {
...
class ContentWrapper extends Component {
  constructor(props) {
    super(props)
    this.wrapperMain = createRef();
  }

  componentDidMount() {
    this.wrapperMain.current.focus()
  }

  render() {
    return (
      <main ref={this.wrapperMain} {...ArrowKeysReact.events} id="main" tabIndex="1">
        {this.props.children}
      </main>
    )
  }
